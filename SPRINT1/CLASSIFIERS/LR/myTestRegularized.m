...
s=3;
t=5;
load( '/media/jairo/My Passport/EGGFertility/miscelaneus/DatasetTest/balancedAllSlidesAVG1.mat' );
data    = [allSlidesAVG.fertileEggsAVGSignatures{s}.mean(:,[38-t:38+t 172]); allSlidesAVG.nonfertileEggsAVGSignatures{s}.mean(:,[38-t:38+t 172])];
%n       = size(data,2);
